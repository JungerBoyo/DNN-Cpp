...
{   
    ...
    Tx1.primValue = 1.f;
    auto Tyx1 = ((Tx1 * Tx2) + Tx2) * Tx1;

    Tx1.primValue = 0.f;
    Tx2.primValue = 1.f;
    auto Tyx2 = ((Tx1 * Tx2) + Tx2) * Tx1;
    ...
    auto y = args[0]*(args[1] + args[2]) + 2.f*args[3]*args[4] + args[3] * args[3] * args[3] + 2.f*args[0]*args[0];
